...
const slidesData = [
  {
    text: 'Store, share, and sort sheet music with ease!',
  ...
  {
    text: 'Organize your sheet music library effortlessly!',
  ...
  {
    text: 'Collaborate with others and share your sheet music!',
